...
\\
\begin{tabularx}{\textwidth}{lX}
 Description & The current game frame, sent per 50 frames (which is also the interval at which construction sites are updated). For more information see Section \ref{game speed}.  \\
 Type & Send on change \\
 Syntax &  \verb|frame(<number>)| \\
 Example & \verb|frame(150)|   \\
 \end{tabularx}
 \begin{tabularx}{\textwidth}{l | c | p{8cm}|}
 \cline{2-3}
  Parameters & \textbf{\verb|<number>|} & The game frame in increments of 50. \\
             & \textbf{Type} & \verb|Positive Integer| \\
             & \textbf{Range} & [0--$\infty$] \\
            \cline{2-3}
\end{tabularx}
...
\begin{tabularx}{\textwidth}{lX}
 ...
 Type & Send once \\
 Syntax & \verb|base(<X>,<Y>,<IsStart>,<ResourceGroupID>)| \\
...
\noindent
\textbf{UnitRegion/2 percept}\\
\\
\begin{tabularx}{\textwidth}{lX}
 Description & Gives information about which region on the map a unit is in. \\
 Type & Send on change \\
 Syntax & \verb|unitRegion(<UnitID>,<RegionID>)| \\
 Example & \verb|unitRegion(12, 15)| \\
 \end{tabularx}
 \begin{tabularx}{\textwidth}{l | c | p{8cm}|}
 \cline{2-3}
