...
public class Configuration {
	...
	private void parseParams(Map<String,Parameter> parameters) throws NoTranslatorException, TranslationException {
	...
	private void checkSanity() {
		if(race == null || map == null || sc_dir == null){
			throw new IllegalStateException("Map, Race and starcraft directory have to be defined in the .mas2g file");
		}
	}
