...
public class TotalResourcesPerceiver extends Perceiver {
  ...
  public List<Percept> perceive() {
    ...
    percepts.add(new TotalResourcesPercept(self.getMinerals(), self.getCumulativeMinerals(), 
        self.getGas(), self.getCumulativeGas(), self.getSupplyUsed(), self.getSupplyTotal()));
