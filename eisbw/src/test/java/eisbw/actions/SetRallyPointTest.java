...
public class SetRallyPointTest {

  private SetRallyPoint action;
  ...
  public void start() {
    ...
    action = new SetRallyPoint(bwapi);
  ...
  public void execute_test() {
    ...
    verify(unit).setRallyPoint(new Position(1, 2, Position.PosType.BUILD));
  }
  
  @Test
  public void toString_test() {
    assertEquals("setRallyPoint(x,y)", action.toString());
  }
